...
const App = () => {
    ...
    const [loginState, dispatch] = React.useReducer(loginReducer, initialLoginState); //use of reducer as LoginState and further will be used in overall code
    ...
    useEffect(() => {
        ...
        }, 500); //it's is actually loader screen 1000ms, in btw we check whether the user has login or no
    }, []);   //empty array?
